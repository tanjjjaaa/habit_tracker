...
const API_URL = 'https://6bbfdda9-8d6c-4a37-ad54-b11541719efd.tunnel4.com/api';
// ====================================
...
function loadHabitsFromAPI() {
    ...
    fetch(`${API_URL}/habits/user/${userId}`)
        ...
        .then(data => {
            ...
            console.log(JSON.stringify(data, null, 2)); // ПОКАЖЕТ ВСЁ, ЧТО ПРИШЛО
            habits = data.map(habit => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (userId) {
        ...
        // Загружаем привычки
        loadHabitsFromAPI();
        // Переключаем на главную (минуя авторизацию)
        ...
        // Если не авторизован — показываем календарь и привычки
        initCalendar();
        renderHabits();
        setupModalEvents();
    }
